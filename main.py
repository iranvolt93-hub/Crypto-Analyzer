...
async def search_crypto(q):
    qn = normalize(q)
    if qn in {
        "xau", "xauusd", "gold", "goldusd", "globalgold",
        "طلایجهانی", "طلایجهان", "طلای جهانی", "اونس", "اونس طلا", "ounce"
    }:
        return [{
            "id": "xauusd",
            "symbol": "XAU/USD",
            "name": "طلای جهانی (اونس طلا)",
            "asset_type": "xau"
        }]
...
async def start(update, ctx):
    ...
    await update.message.reply_text(
        ...
        "رمزارزها و طلای ۱۸ عیار را مدیریت کن.\n"
